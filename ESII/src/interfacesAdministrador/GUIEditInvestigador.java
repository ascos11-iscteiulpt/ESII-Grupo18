...
public class GUIEditInvestigador extends JFrame{
	...
	public GUIEditInvestigador(ConnectionsAdmin connect, GUIGerirInvestigadores gui) {
	...
	private void openGui() {
		...
		insertV.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					connectAdmin.editInvestigador(nameField.getText(), gui.getSelectedID());
					gui.updateTable();
					gui.repaintTable();
					closeGUI();
