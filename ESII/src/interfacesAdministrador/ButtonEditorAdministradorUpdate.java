...
public class ButtonEditorAdministradorUpdate extends DefaultCellEditor {
	...
	public ButtonEditorAdministradorUpdate(JCheckBox checkBox, GUIGerirAdministradores gui) {
		super(checkBox);
		this.gui = gui;
	...
	public Object getCellEditorValue() {
		if (isPushed) {
			...
			try {
				...
				final String name = (String)gui.getTable().getValueAt(row, 1);
				...
				new GUIEditAdministrador(gui.connectAdmin, gui);
				gui.updateTable();
				gui.repaintTable();
